...
export default function Jobs() {
    return (
        <main className="flex min-h-screen max-w-5xl flex-1 flex-col gap-7 max-sm:gap-5">
            ...
            <section className="card-wrapper dark:card-wrapper-dark flex max-w-md flex-col items-center justify-center gap-5 rounded-lg p-10 text-center max-sm:p-2">
                ...
                <div className="mt-4 flex gap-5 max-sm:gap-3">
                    <Link
                        href="/"
                        className="paragraph-regular btn-secondary text-dark400_light900 text-nowrap rounded-[10px] p-3"
                    >
                        Explore Questions
                    </Link>
                    <Link
                        href="/community"
                        className="paragraph-regular primary-gradient text-nowrap rounded-[10px] p-3 text-light-900"
                    >
                        Connect with Devs
                    </Link>
                </div>
